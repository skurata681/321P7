...
directory = os.fsencode('C:/Users/manis/Documents/C321p7DataManagement/sonde/')
fn = 'C:/Users/manis/Documents/C321p7DataManagement/sonde/'
GoodData = [[]]
dates = []
...
for file in os.listdir(directory):
  ...
  #grab the data in arrays for each day
    ...
    for a in varnames: #add varnames1
        rawdata = ds[a][:]
 ...
 #Now we need to add this list to a list of lists to get all the data!
    if (cool==0):
        varnames.insert(0, 'dates') #varnames1
        GoodData.append(varnames) #varnames1
...
#my_df.to_csv('DailyDataSonde.csv', index=False, header=False)
